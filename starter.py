...
# Get command line arguments or print usage and exit  211119
cam_file='cam5.png'
proj_file='projector.png'
...
#     print ('usage: '+progname+' PROJIMAGE CAMIMAGE',sys.stderr)
#     sys.exit(1)
...
cv2.waitKey(0)#while cv2.waitKey(5) < 0: pass
